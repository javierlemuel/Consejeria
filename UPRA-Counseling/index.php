...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../new_template/vristo-html-main/assets/css/perfect-scrollbar.min.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="../new_template/vristo-html-main/assets/css/style.css" />
    <link defer rel="stylesheet" type="text/css" media="screen" href="../new_template/vristo-html-main/assets/css/animate.css" />
    <script src="../new_template/vristo-html-main/assets/js/perfect-scrollbar.min.js"></script>
    <script defer src="../new_template/vristo-html-main/assets/js/popper.min.js"></script>
    <script defer src="../new_template/vristo-html-main/assets/js/tippy-bundle.umd.min.js"></script>
    <script defer src="../new_template/vristo-html-main/assets/js/sweetalert.min.js"></script>
</head>
...
<body>
    ...
    <!-- <div class="screen_loader animate__animated fixed inset-0 z-[60] grid place-content-center bg-[#fafafa] dark:bg-[#060818]">
            <svg width="64" height="64" viewBox="0 0 135 135" xmlns="http://www.w3.org/2000/svg" fill="#e0c200">
                <path
    ...
    <div class="flex min-h-screen flex-col">
        ...
        <header class="z-40" :class="{'dark' : $store.app.semidark && $store.app.menu === 'horizontal'}">
            <div class="shadow-sm">
                <div class="relative flex justify-around items-center bg-warning p-5 dark:bg-[#0e1726]">
                    <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 ">
                        <img class="inline w-48 ltr:-ml-1" src="../UPRA-Consejeria-master/photos/uprarecibo.png" alt="">
                    </div>
                    <div class="hidden ltr:mr-2 rtl:ml-2 sm:block">
                        <ul class="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6] text-white">
                            <li>Inicio</li>
                            <li>Acerca</li>
            ...
            <div class="main-content h-full items-center p-4">
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                            <h1 class="h1">¡Bienvenidos a Consejería Académica de la Universidad de Puerto Rico Recinto de Arecibo!</h1>
