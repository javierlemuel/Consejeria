    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <script>
            ...
            const clearCourse = (course) => {
                ...
                var storedArrayJSON = sessionStorage.getItem('selectedCourses');
                var storedArray = JSON.parse(storedArrayJSON) || []; // Default to an empty array if sessionStorage is empty or not valid JSON

                // Find the index of the element to delete
                var indexToDelete = storedArray.indexOf(course.id);
                ...
                if (indexToDelete !== -1) {
                    ...
                    sessionStorage.setItem('selectedCourses', JSON.stringify(storedArray));
                }
            }
            ...
            $(document).ready(() => {
                ...
                $('input[type="checkbox"]').change(() => {
                    ...
                    if (checkedCheckboxes.length > 0) {
                        ...
                        checkedCheckboxes.each((i, selectedCourse) => {
                            ...
                            if (!courseList.includes(selectedCourse.value)) {
                                ...
                                //sessionStorage.setItem('selectedCourses', JSON.stringify(myArray));
                            ...
                            //sessionStorage.setItem('selectedCourses', JSON.stringify(courseList));
                        });
                        sessionStorage.setItem('selectedCourses', JSON.stringify(courseList));
                    ...
                    //** se borra el curso de la lista cuando se hace uncheck */

                    //pensar como cambiar esto, cuando haya un cambio en el checkbox se verifica si es notchecked 
                    // y se borra del sidebar 
                    //ahora mismo siempre se verfican los checked boxes que son uncheck y se verifica que si esta enla 
                    //otra lista pues los remueve
