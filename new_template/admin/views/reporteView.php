    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <div class="main-content flex flex-col min-h-screen">
            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]" style='padding: 5% 10%'>
                ...
                <div style='text-align:center; font-size: 35px'><h2>Reportes Generales</h2></div>
                <br><br><br>
                ...
                <table style='font-size: 20px'>
                    ...
                    <tbody>
                        ...
                        <tr style='background-color: lightgray'>
                            <td style='text-align:center'>Estudiantes que llenaron Consejería</td>
                            <td style='text-align:center'><?php echo $studentsRegistrados  ?></td>
                        </tr>
                        <tr>
                            <td style='text-align:center'>Expedientes revisados/editados</td>
