                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            ...
                            <?php if (isset($_SESSION['message'])) { ?>
                                <div style='padding: 15px 0' class="flex flex-wrap items-center justify-between gap-4">
                                            ...
                                            <?php if ($_SESSION['message'] == 'no admin')
                            ...
                            <form class="space-y-5 dark:text-white" method="post" action="controllers/loginController.php">
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input id="Email" name="email" type="email" placeholder="ejemplo@upr.edu" class="form-input ps-10 placeholder:text-white-dark" required/>
                                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                ...
                                                <path d="M14.3465 6.02574C14.609 5.80698 14.6445 5.41681 14.4257 5.15429C14.207 4.89177 13.8168 4.8563 13.5543 5.07507L11.7732 6.55931C11.0035 7.20072 10.4691 7.6446 10.018 7.93476C9.58125 8.21564 9.28509 8.30993 9.00041 8.30993C8.71572 8.30993 8.41956 8.21564 7.98284 7.93476C7.53168 7.6446 6.9973 7.20072 6.22761 6.55931L4.44652 5.07507C4.184 4.85630 3.79384 4.89177 3.57507 5.15429C3.35630 5.41681 3.39177 5.80698 3.65429 6.02574L5.46640 7.53583C6.19764 8.14522 6.79033 8.63914 7.31343 8.97558C7.85834 9.32604 8.38902 9.54743 9.00041 9.54743C9.61180 9.54743 10.14250 9.32604 10.68740 8.97558C11.21050 8.63914 11.80320 8.14522 12.53440 7.53582L14.34650 6.02574Z" fill="currentColor" />
                                            </svg>
                                        </span>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input id="Password" name="password" type="password" placeholder="Entre su contraseña" class="form-input ps-10 placeholder:text-white-dark" required/>
                                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        </span>
                                    </div>
                                </div>
                                <button type="submit" class="btn !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]" style="background: #2b2b2b; color: white;">
                                    Login
                                </button>
                            </form>
                        </div>
