...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <div class="main-content flex flex-col min-h-screen">
            ...
            <?php if (isset($message)) { ?>
                ...
                <?php } else {   
                           echo "<h2 style='color:limegreen; bold' class='text-xl'>Message not found!</h2>";
                           } ?>
    ...
    <div class="border border-[#d3d3d3] dark:border-[#1b2e4b] rounded">
        ...
        <form class="space-y-5" action='?minor&mID=<?php echo $minor['ID']?>' method='POST'>
            <tr style='text-align:center'>

            <td style='text-align:center'>
            <input name='mID' type="number" class="form-input" value="<?php echo $minor['ID']?>" required readonly/>
            </td>
            <td style='text-align:center'>
