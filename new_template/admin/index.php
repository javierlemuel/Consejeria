                                                        ...
                                                        <form @submit.prevent="saveUser">
                                                            ...
                                                            <div class="mb-5">
                                                                ...
                                                                <input
                                                                    id="tipo"
                                                                    type="text"
                                                                    placeholder="(Regular, Readmision, Traslado o Transferencia)"
                                                                    class="form-input"
                                                                    x-model="params.tipo"
                                                                />
                                                            </div>
            ...
            Alpine.data('contacts', () => ({
                    ...
                    contactList: [
                        ...
                        },
                        {
                            ...
                            priority: 'activo',
                            tipo: 'Regular',
                            birth_year: '2022-05-10',
                        },
                        {
                            id: 3,
                            path: 'profile-35.png',
                            nombre: 'Melvin R. Lopez Reyes',
                            role: 'Web Developer',
                            ...
                            priority: 'activo',
                            tipo: 'Regular',
                            birth_year: '2022-10-12',
                        },
                        {
                            id: 4,
                            path: 'profile-35.png',
                            nombre: 'Jean M. Deida Quinones',
                            role: 'Web Developer',
                            ...
                            priority: 'activo',
                            tipo: 'Regular',
                            birth_year: '2001-09-12',
                        },
                        {
                            id: 5,
                            path: 'profile-35.png',
                            nombre: 'Natalia M. Zapato Monterrey',
                            role: 'Web Developer',
