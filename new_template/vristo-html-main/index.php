                    ...
                    <div class="relative flex w-full items-center bg-warning px-5 py-2.5 dark:bg-[#0e1726]">
                        ...
                        <div class="hidden ltr:mr-2 rtl:ml-2 sm:block">
                            <ul class="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                                <li>
                                    <a href="consejeria.php" class="block p-2 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60">
                                        Consejería
                                    </a>
                                </li>

                                <li>
                                    <a href="cohortes.php" class="block hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60">
                                        Cohorte
                                    </a>
                                </li>
