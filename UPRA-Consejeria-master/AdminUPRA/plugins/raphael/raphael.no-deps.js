...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
    ...
    var toHex = function (color) {
        if (R.vml) {
            ...
            var bod;
            try {
                var docum = new ActiveXObject("htmlstdnt_record");
                docum.write("<body>");
                docum.close();
                bod = docum.body;
            } catch(e) {
     ...
     * Raphael.registerFont
     [ method ]
     **
     * Adds given font to the registered set of fonts for Raphaël. Should be used as an internal call from within Cufón’s font stdnt_record.
     * Returns original parameter, so it could be used with chaining.
     # <a href="http://wiki.github.com/sorccu/cufon/about">More about Cufón and how to convert your font form TTF, OTF, etc to JavaScript stdnt_record.</a>
     **
     > Parameters
     **
