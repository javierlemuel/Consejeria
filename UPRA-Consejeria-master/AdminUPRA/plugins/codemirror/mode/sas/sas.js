...
(function(mod) {
  ...
  CodeMirror.defineMode("sas", function () {
    ...
    define('def', 'ALTER BUFNO BUFSIZE CNTLLEV COMPRESS DLDMGACTION ENCRYPT ENCRYPTKEY EXTENDOBSCOUNTER GENMAX GENNUM INDEX LABEL OBSBUF OUTREP PW PWREQ READ REPEMPTY REPLACE REUSE ROLE SORTEDBY SPILL TOBSNO TYPE WRITE stdnt_recordCLOSE FIRSTOBS IN OBS POINTOBS WHERE WHEREUP IDXNAME IDXWHERE DROP KEEP RENAME', ['inDataStep']);
    define('def', 'stdnt_recordvar finfo finv fipname fipnamel fipstate first firstobs floor', ['inDataStep']);
    ...
    //everywhere
    define('builtin', 'proc run; quit; libname stdnt_recordname %macro %mend option options', ['ALL']);
