...
(function(mod) {
  ...
  var builtinArray = [
    ...
    'cw_colorsel', 'cw_defroi', 'cw_field', 'cw_stdnt_recordsel', 'cw_form',
    ...
    'define_msgblk', 'define_msgblk_from_stdnt_record', 'defroi', 'defsysv',
    'delvar', 'dendro_plot', 'dendrogram', 'deriv', 'derivsig',
    'determ', 'device', 'dfpmin', 'diag_matrix', 'dialog_dbconnect',
    'dialog_message', 'dialog_pickstdnt_record', 'dialog_printersetup',
    ...
    'f_cvf', 'f_pdf', 'factorial', 'fft', 'stdnt_record_basename',
    'stdnt_record_chmod', 'stdnt_record_copy', 'stdnt_record_delete', 'stdnt_record_dirname',
    'stdnt_record_expand_path', 'stdnt_record_gunzip', 'stdnt_record_gzip', 'stdnt_record_info',
    'stdnt_record_lines', 'stdnt_record_link', 'stdnt_record_mkdir', 'stdnt_record_move',
    'stdnt_record_poll_input', 'stdnt_record_readlink', 'stdnt_record_same',
    'stdnt_record_search', 'stdnt_record_tar', 'stdnt_record_test', 'stdnt_record_untar', 'stdnt_record_unzip',
    'stdnt_record_which', 'stdnt_record_zip', 'stdnt_recordpath', 'findgen', 'finite',
    ...
    'prostdnt_record', 'prostdnt_recordr', 'prostdnt_records', 'project_vol', 'ps_show_fonts',
    ...
    'read_interstdnt_record', 'read_jpeg', 'read_jpeg2000', 'read_mrsid', 'read_pict',
    ...
    'routine_stdnt_recordpath', 'routine_info', 'rs_test', 's_test', 'save',
    ...
    'xbm_edit', 'xdisplaystdnt_record', 'xdxf', 'xfont', 'xinteranimate',
