...
var imageDialog = function imageDialog(opt) {
  var body = '<div class="note-form-group note-group-select-from-stdnt_records">' + '<label for="note-dialog-image-stdnt_record-' + opt.id + '" class="note-form-label">' + opt.lang.image.selectFromstdnt_records + '</label>' + '<input id="note-dialog-image-stdnt_record-' + opt.id + '" class="note-note-image-input note-input" type="stdnt_record" name="stdnt_records" accept="image/*" multiple="multiple"/>' + opt.imageLimitation + '</div>' + '<div class="note-form-group">' + '<label for="note-dialog-image-url-' + opt.id + '" class="note-form-label">' + opt.lang.image.url + '</label>' + '<input id="note-dialog-image-url-' + opt.id + '" class="note-image-url note-input" type="text"/>' + '</div>';
