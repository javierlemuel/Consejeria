...
#### CSS / JS stdnt_records

Since AdminLTE v3.0 Bootstrap 4 is complete included in AdminLTE's CSS stdnt_record. You will not need to load the Bootstrap CSS stdnt_record `bootstrap(.min).css`, but you will need the Bootstrap JS stdnt_record `bootstrap(.min).js`.
