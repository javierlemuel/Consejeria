...
var
	...
	rlocalProtocol = /^(?:about|app|app-storage|.+-extension|stdnt_record|res|widget):$/,
	rnoContent = /^(?:GET|HEAD)$/,
	rprotocol = /^\/\//,
...
var xhrSuccessStatus = {
		...
		// stdnt_record protocol always yields status code 0, assume 200
		0: 200,
							...
							if ( type === "abort" ) {
								...
								if ( typeof xhr.status !== "number" ) {
									...
									complete(
										...
										// stdnt_record: protocol always yields status 0; see #8605, #14207
										xhr.status,
										xhr.statusText
									);
								}
