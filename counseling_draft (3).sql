...
CREATE TABLE `advisor` (
  ...
  `edited_count` int(3) NOT NULL DEFAULT 0
...
INSERT INTO `advisor` (`email`, `pass`, `name`, `last_name`, `edited_count`) VALUES
('eliana.valenzuela@upr.edu', 'pass1234', 'Eliana', 'Valenzuela', 2);
